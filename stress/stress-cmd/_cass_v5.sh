...
echo 'START write, 128x thread: 8/1...'
...
echo 'START read, 128x thread: 9/1...'
...
echo 'START remove: 13/1...'
python3.11 stress/stress_mng.py remove -e compareV4V5_sequenceTHR/_cass_v5_1_local_one.env -k keyspace1 -d stress -s 8

echo 'START write, 128x thread: 14/1...'
...
echo 'START read, 128x thread: 15/1...'
...
echo 'START read, 128x thread: 19/1...'
...
echo 'START write, 128x thread: 24/1...'
...
echo 'START read, 128x thread: 25/1...'
...
echo 'START remove: 29/1...'
python3.11 stress/stress_mng.py remove -e compareV4V5_sequenceTHR/_cass_v5_2_local_quorum.env -k keyspace1 -d stress -s 8

echo 'START write, 128x thread: 30/1...'
...
echo 'START read, 128x thread: 31/1...'
